...
// client.settings.set(message.guild.id, {})
  ...
  // message.reply(settings.prefix.value)
  ...
  if (level < client.levelCache[cmd.conf.permLevel]) {
    if (settings.systemNotice.value === "Enabled") {
  ...
  if (settings.globalPoints.value == "Enabled") {
  ...
  if (client.points.getProp(key, "level") < curLevel) {
    ...
    if (settings.levelUpMessage.value == "Enabled") {
